...
class LightingModel(db.Model):
    ...
    def to_json(self) -> dict:
        ...
        "fitting_no":self.fitting_no,
        "lamp_rating":self.lamp_rating,
        "lamp_no":self.lamp_no,
        ...
        "required_lux_level":self.required_lux_level,
        "actual_lux_level":self.actual_lux_level,
